...
// {
//     // int chunk_size = 8;
//     int aligned_n = (n / svcntw()) * svcntw(); // Largest multiple of 8 ≤ N
//     int aligned_m = (m / svcntw()) * svcntw(); // Largest multiple of 8 ≤ N
//     svbool_t pred;

//     // Process full 8×8 blocks
//     for (int bi = 0; bi < aligned_m; bi += svcntw) 
//     {
//         for (int bj = 0; bj < aligned_m; bj += svcntw())
//         {
//             for (int bk = 0; bk < aligned_n; bk += svcntw())
//             {
//                 // Load 8 rows of m2
//                 for (int rowm2 = bk; rowm2 < bk + svcntw(); rowm2 += 4)
//                 {
...
//                     for (int rowm1 = bi; rowm1 < bi + svcntw(); rowm1++)
//                     {
